...
import hms.hospital.Code.PatientCode;
import hms.hospital.DbConeection.DB;
import static hms.hospital.GUI.PatientRegistration.Gender;
...
public class Patient extends javax.swing.JFrame {
    ...
    public  void searchPatient() {
        ...
        PatientObj patientObj = PatientCode.search(id);
        
        jTextField1.setText(patientObj.getPatient_id());
        jTextField2.setText(patientObj.getPatient_name());
        jTextField3.setText(patientObj.getAge() + "");
        jTextField4.setText(patientObj.getGender());
        jTextField5.setText(patientObj.getNic());
        jTextField6.setText(patientObj.getBloodGroup());
        jTextField7.setText(patientObj.getAdmit_id());
        jTextField8.setText(patientObj.getAdmit_date());
        jTextArea1.setText(patientObj.getMedical());
        jTextField9.setText(patientObj.getWard_id());
        jTextField10.setText(patientObj.getWard_name());
        jTextField13.setText(patientObj.getExternal());
        jTextField14.setText(patientObj.getConsultant());
        jTextField15.setText(patientObj.getRecommand());
        jLabel8.setText(patientObj.getDischarge());
    ...
    public void setPatient() {
        try {
           ...
           PatientObj patientObj = PatientCode.search(lst[0]);
    ...
    private void initComponents() {
        ...
        jPanel9.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 80, 150, 60));
