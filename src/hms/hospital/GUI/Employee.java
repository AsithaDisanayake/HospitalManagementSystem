...
import hms.hospital.Code.DoctorCode;
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, -1, -1));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrator", "Doctor", "MLT", "Receptionist" }));
        ...
        jPanel1.add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 120, -1));

        jLabel14.setText("Doctor ID");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (!jTextField2.getText().isEmpty() && !jTextField3.getText().isEmpty() && !jTextField4.getText().isEmpty() && !jTextField5.getText().isEmpty() && !jTextField6.getText().isEmpty()) {
                ...
                String d = "Doctor";
                if ((jComboBox2.getSelectedItem().toString()).equals(d)) {
                    DoctorObj docObj = new DoctorObj();
                    docObj.setEmp_id(jTextField1.getText());
                    docObj.setEmp_name(jTextField2.getText());
                    docObj.setDocID(jTextField9.getText());
                    docObj.setSpeciality("Null");

                    DoctorCode docSave = new DoctorCode();
                    docSave.save(docObj);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Check Text filds");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if ((jComboBox2.getSelectedItem().toString()).equals(d)) {
                ...
                DoctorCode docDelete = new DoctorCode();
                docDelete.delete(docObj);
...
//                docObj.setEmp_name(jTextField2.getText());
//                docObj.setDocID(jTextField9.getText());
//                docObj.setSpeciality(jComboBox2.getSelectedItem().toString());
//
//                DoctorCode docSave = new DoctorCode();
//                docSave.save(docObj);
//            }
